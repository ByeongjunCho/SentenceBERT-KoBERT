...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='D:/KoBERT_training/output/NLI/KoBERT-2021-04-23_11-37-51', help='NLI model path')
    ...
    model_name = '/KoBERT'
    tail = '/NLI_STS/' + model_name.replace("/", "") + '-'+datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
    model_save_path = 'D:\KoBERT_training/output' + tail

    # Load NLI model
    model_load_path = args.path
